    ...
    <View style={styles.container}>
      ...
      <View style={styles.onOff}>
        <TouchableOpacity
          style={[
            styles.button,
            { backgroundColor: waitGreen ? "#FAD201" : colors.btnColor },
          ]}
        ...
        <TouchableOpacity
          style={[
            styles.button,
            { backgroundColor: waitRed ? "#FAD201" : "red" },
          ]}
...
function switchOn(setWaitGreen) {
  ...
  const fetchNow = function () {
    fetch("https://api.thingspeak.com/update?api_key=NS8W5PWJY92J9436&field1=1")
      .then((response) => {
...
async function switchOff(setWaitRed) {
  setWaitRed(true);
  const fetchNow = function () {
    fetch("https://api.thingspeak.com/update?api_key=NS8W5PWJY92J9436&field1=0")
      .then((response) => {
        return response.text();
      })
